...
START_SCRIPT="$REPO_ROOT/packages/core/skills/brainstorming/scripts/start-server.sh"
STOP_SCRIPT="$REPO_ROOT/packages/core/skills/brainstorming/scripts/stop-server.sh"
SERVER_JS="$REPO_ROOT/packages/core/skills/brainstorming/scripts/server.js"
